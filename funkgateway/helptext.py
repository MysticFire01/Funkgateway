...
<h3>PC / TeamSpeak</h3>
<p>Ab Version 0.5.9.28 gibt es zwei Betriebsarten. <b>Funk-Gateway</b> zeigt die komplette Funkoberfläche.
<b>PC / TeamSpeak</b> baut eine vereinfachte Oberfläche ohne PTT, COS, Funk-RX, Rufzeichenbake und HF-Audio auf.</p>
<ul>
<li>Channel Commander wird am normalen TeamSpeak-PC auf Wunsch nur während des eigenen Sprechens gesetzt und danach wieder entfernt.</li>
<li>Der PC-Papagei ist ein lokaler Mikrofontest: erst aufnehmen, danach wiedergeben. Dadurch entsteht keine interne Audio-Endlosschleife.</li>
<li>TeamSpeak, Updates, Protokoll und Hilfe bleiben sichtbar.</li>
<li>Beim Wechsel in den PC-Modus wird ein eventuell laufender Funk-Gateway-Betrieb beendet.</li>
</ul>

<h3>Moderation im PC-Modus</h3><p>Die Moderation hat einen eigenen Reiter, damit die Bedienung ohne langes Scrollen möglich ist.</p>
<p>Im PC-/TeamSpeak-Modus können sichtbare TeamSpeak-Benutzer manuell moderiert werden, wenn der eigene Benutzer die nötigen Rechte hat.</p>
<ul>
<li>Poke senden</li>
<li>Benutzer verschieben</li>
<li>Aus dem Channel kicken</li>
<li>Vom Server kicken</li>
</ul>
<p>Kick und Verschieben werden nicht automatisch ausgeführt. Kritische Aktionen brauchen eine Bestätigung.</p>

<h3>Einfache / erweiterte Gateway-Ansicht</h3>
<p>Auf der Startseite gibt es den Haken <b>Erweiterte Einstellungen anzeigen</b>.</p>
<ul>
<li>Haken aus: vereinfachte Oberfläche für den normalen Gateway-Betrieb.</li>
<li>Haken an: alle zusätzlichen Gateway- und Expertenreiter werden eingeblendet.</li>
<li>Die Funktionen werden nicht gelöscht; nur selten benötigte Einstellseiten werden verborgen.</li>
<li><b>Moderation</b> gehört ausschließlich zu PC / TeamSpeak und wird im Funk-Gateway-Modus nie angezeigt.</li>
</ul>

<h3>Auch innerhalb sichtbarer Reiter</h3>
<p>In der einfachen Ansicht werden zusätzlich technische Feinwerte ausgeblendet. FunkGateway verwendet diese Werte intern weiter.</p>
<ul>
<li>Neue Installationen verwenden die bewährten Standardwerte.</li>
<li>Vorhandene eigene Einstellungen werden nicht überschrieben.</li>
<li>Mit <b>Erweiterte Einstellungen anzeigen</b> werden die Felder sofort wieder sichtbar.</li>
</ul>

<h3>Einrichtung und Wartung</h3>
<p>Auf der Startseite stehen zusätzliche Hilfen für den normalen Betrieb zur Verfügung:</p>
<ul>
<li><b>Einrichtungsassistent:</b> sucht Geräte und prüft PTT/VoIP, ohne automatisch zu senden.</li>
<li><b>Selbsttest:</b> prüft die wichtigsten Voraussetzungen und zeigt verständliche Ergebnisse.</li>
<li><b>Sichern/Wiederherstellen:</b> komplette Konfiguration exportieren und wieder einlesen.</li>
<li><b>Profile:</b> verschiedene lokale Konfigurationen speichern und umschalten.</li>
<li><b>Systemstatus:</b> schnelle Übersicht über Audio, PTT, VoIP und Konfiguration.</li>
<li><b>Diagnosepaket:</b> erzeugt ein ZIP für die Fehlersuche; bekannte Geheimnisse werden entfernt.</li>
</ul>
"""
...
# 0.5.9.28: TOTP-QR-Code lokal mit qrencode anzeigen.
...
# 0.5.9.28:
# - Updater setzt nach ZIP-Entpackung die Ausführungsrechte der Shell-Skripte.
# - Optional automatische Installation im Terminal inkl. sichtbarer sudo-Abfrage.
# - Optional install-desktop.sh für Schnellstarter auf den neuen Versionsordner.
